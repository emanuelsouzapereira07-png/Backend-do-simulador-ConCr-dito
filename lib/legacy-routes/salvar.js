...
export default async function handler(req, res){
  ...
  try{
    ...
    const row={
      ...
      supervisor_feedback: payload.supervisorFeedback || payload.supervisor_feedback || '',
      xp: payload.xp,
      rank: payload.rank,
